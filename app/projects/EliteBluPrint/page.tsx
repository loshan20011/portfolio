...
const functionalities = ["User Authentication", "payment gateway", "auto generated floor plan", "Responsive UI"]
const techStack = ["ReactJS", "Tailwind CSS", "MongoDB", "Express API", "Firebase", "Python" , "JWT tokens"];
        ...
        <div className="flex flex-col items-start">
          <div className="mt-20 md:mt-24 mb-40 md:mb-0 w-[340px] md:w-[400px] md:h-[200px] h-0 relative">
            <Image
              ...
              onClick={() => {
                window.open("https://elitebluprint.live/", "_blank");
              }}
            />
          </div>
          ...
          In this project, I pioneered and executed a groundbreaking concept: transforming text descriptions into visually stunning 2D floor plans through innovative implementation. It led back-end CRUD operations, API connections and front-end.
            The elite blue print implemented the backend logic (algorithm), responsible for the innovative generation of 2D floor plans.          </p>
        </div>
